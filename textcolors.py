...
def rainbow(input_to_be_formatted, color_dict=color_dictionary):
    ...
    for text_index, text_item in enumerate(text_list):
        ...
        color_formatted_text = f"\033[0;{color_dictionary[current_color]}m{text_item}\033[0m"
...
class ColorWheel():
    ...
    def arrows(self):
        ...
        for color in self.color_list:
            color_arrow_string = color_arrow_string + f"\033[0;{color}m{arrow_option}\033[0m"
